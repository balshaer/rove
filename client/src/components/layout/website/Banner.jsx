...
export default function Banner() {
  return (
    <div
      ...
      id="home"
    >
      <div className="mx-auto container flex items-center justify-between p-5 max-md:h-max  text-start h-[80vh] max-md:flex-col max-md:text-center max-md:items-center max-md:justify-center max-md:gap-8 ">
